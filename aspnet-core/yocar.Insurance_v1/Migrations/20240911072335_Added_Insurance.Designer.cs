...
{
    [DbContext(typeof(Insurance_v1DbContext))]
    [Migration("20240911072335_Added_Insurance")]
    partial class Added_Insurance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("yocar.Districts.District", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("yocar.Insurance_v1.Entities.ContactPersons.ContactPerson", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("yocar.Insurance_v1.Entities.Locations.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("yocar.ProvinceCities.ProvinceCity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ProvinceCities", (string)null);
                });

            modelBuilder.Entity("yocar.Wards.Ward", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("yocar.Districts.District", b =>
                {
                    b.HasOne("yocar.ProvinceCities.ProvinceCity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("yocar.Insurance_v1.Entities.Locations.Location", b =>
                {
                    b.HasOne("yocar.Wards.Ward", null)
                        .WithMany()
            ...
            modelBuilder.Entity("yocar.Wards.Ward", b =>
                {
                    b.HasOne("yocar.Districts.District", null)
                        .WithMany()
